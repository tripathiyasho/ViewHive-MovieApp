...
const Nav = () => {
  ...
  return (
    ...
    <nav className="sticky top-0 z-50 backdrop-blur-lg border-b border-neutral-700/80  lg:text-sm text-white">
        ...
        <div className="flex justify-between items-center flex-shrink-0 lg:p-2">
          ...
          <button onClick={toggleSidenav}>
              {isSidenavOpen ? <i className="hover:text-[#E50914] ri-close-circle-line text-2xl  "></i> : <i className="ri-menu-line  text-2xl hover:text-[#E50914]  "> </i>}
            </button>
          </div>
    ...
    {!isSidenavOpen && <div
    className={"absolute w-[43%] left-[18%] max-h-[50vh]  backdrop-blur-lg border-b border-neutral-700/80   top-[10] overflow-auto  z-100"}
  >
    {searches.map((s, i) => (
      <Link
  ...
  {/* Dropdown Menu */}
  {isSidenavOpen && <div className="fixed z-20 backdrop-blur-lg  w-full flex flex-col    ">
    <nav className=" ml-2 text-white ">
      ...
      <Link
        ...
        <Link to="/popular" className=" hover:bg-[#E50914]  duration-300 rounded-lg p-3">
          <i className=" ri-bard-fill"></i>
          Popular
        </Link>
        <Link to="/movie" className=" hover:bg-[#E50914]  duration-300 rounded-lg p-3">
          <i className=" ri-movie-2-fill"></i>
          Movies
        </Link>
        <Link to="/tv" className=" hover:bg-[#E50914]  duration-300 rounded-lg p-3">
          <i className=" ri-tv-2-fill"></i>
          Tv Shows
        </Link>
        <Link to="/people" className="  hover:bg-[#E50914]  duration-300 rounded-lg p-3 ">
      ...
      <h1 className="font-semibold text-xl  ">
        ...
        <Link className=" hover:bg-[#E50914]  duration-300 rounded-lg p-3">
          <i className=" ri-information-fill"></i> About ViewHive
        </Link>
        <Link className=" hover:bg-[#E50914]  duration-300 rounded-lg p-3">
